...
const styles = StyleSheet.create({ summaryHero: { alignItems: 'center', gap: 6, paddingVertical: spacing.xl }, summaryTitle: { fontSize: type.heading, fontWeight: '800' }, summaryGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, summaryTile: { width: '48%', gap: spacing.xs }, summaryValue: { fontSize: type.subheading, fontWeight: '800' }, summaryRow: { flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: spacing.sm }, previousCard: { padding: 10 }, copyUndo: { padding: spacing.sm }, between: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 }, elapsed: { flexDirection: 'row', justifyContent: 'space-between' }, nav: { flexDirection: 'row', gap: spacing.sm, marginTop: 6 }, setRow: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: 6, borderBottomWidth: StyleSheet.hairlineWidth }, setNumberBtn: { width: 32, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.xs, borderRadius: radius.sm }, setField: { flex: 1, minWidth: 56, borderRadius: 9, alignItems: 'center', paddingVertical: spacing.xs }, setInput: { minWidth: 48, textAlign: 'center', fontWeight: '800', fontSize: 17, padding: 0 }, check: { width: 38, height: 38 }, overlay: { flex: 1, backgroundColor: overlay.scrim, justifyContent: 'center', padding: 22 }, dialog: { borderRadius: radius.xl, padding: 18, gap: spacing.md }, qrDialog: { alignItems: 'center' }, qr: { padding: spacing.md, backgroundColor: '#fff', borderRadius: 14 }, scanner: { flex: 1, padding: spacing.lg, gap: spacing.md }, camera: { flex: 1, minHeight: 360, borderRadius: radius.xl, overflow: 'hidden' }, sharedEntry: { paddingVertical: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#8886' } });
