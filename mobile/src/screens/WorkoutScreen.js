...
import { EFFORT, advancedSetsSummary, effortOf, isBw, modeOf, setLabel, setsDoneActive, supersetUnits, unitOf } from '../lib/history';
...
function EntryBlock({ entryIndex, onToggle, mutate, onDetail, onWork, onSetMenu, onTray }) {
