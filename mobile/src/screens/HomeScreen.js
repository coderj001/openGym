...
export default function HomeScreen({ navigation }) {
  ...
  return <Screen>
    ...
    <Card><View style={styles.between}><View><AppText style={{ fontSize: 21, fontWeight: '800' }}>🔥 {t('{0} week streak', streakWeeks(S))}</AppText><AppText muted style={{ marginTop: 4 }}>{weekCount} {t('this week')} · {t('{0} workouts total', S.workouts.length)}</AppText></View><Icon name="calendar-month" size={28} color={colors.muted} /></View></Card>
